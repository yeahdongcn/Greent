...
#import "RSCenterViewController.h"

#import "RSCenterViewCell.h"

#import "UIColor+Hex.h"

@interface RSCenterViewController ()

@end

@implementation RSCenterViewController
...
{
    static NSString *CellIdentifier = @"CenterViewCell";
